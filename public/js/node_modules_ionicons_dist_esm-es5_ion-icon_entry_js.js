...
/* harmony export */ });
/* harmony import */ var _index_e0fb4cab_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index-e0fb4cab.js */ "./node_modules/ionicons/dist/esm-es5/index-e0fb4cab.js");
/* harmony import */ var _utils_6f78da88_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils-6f78da88.js */ "./node_modules/ionicons/dist/esm-es5/utils-6f78da88.js");
...
var isValid = function (elm) {
    if (elm.nodeType === 1) {
        ...
        for (var i = 0; i < elm.attributes.length; i++) {
            ...
            if ((0,_utils_6f78da88_js__WEBPACK_IMPORTED_MODULE_0__.i)(val) && val.toLowerCase().indexOf('on') === 0) {
                return false;
            }
        }
...
var Icon = /** @class */ (function () {
    function Icon(hostRef) {
        (0,_index_e0fb4cab_js__WEBPACK_IMPORTED_MODULE_1__.r)(this, hostRef);
    ...
    Icon.prototype.loadIcon = function () {
        var _this = this;
        if (this.isVisible) {
            var url_1 = (0,_utils_6f78da88_js__WEBPACK_IMPORTED_MODULE_0__.g)(this);
            if (url_1) {
        ...
        if (!this.ariaLabel && this.ariaHidden !== 'true') {
            var label = (0,_utils_6f78da88_js__WEBPACK_IMPORTED_MODULE_0__.b)(this.name, this.icon, this.mode, this.ios, this.md);
    ...
    Icon.prototype.render = function () {
        ...
        var flipRtl = this.flipRtl ||
            (this.ariaLabel &&
                ...
                this.flipRtl !== false);
        return ((0,_index_e0fb4cab_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_e0fb4cab_js__WEBPACK_IMPORTED_MODULE_1__.H, { role: "img", class: Object.assign(Object.assign((_a = {}, _a[mode] = true, _a), createColorClasses(this.color)), (_b = {}, _b["icon-" + this.size] = !!this.size, _b['flip-rtl'] = !!flipRtl && this.el.ownerDocument.dir === 'rtl', _b)) }, this.svgContent ? ((0,_index_e0fb4cab_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", { class: "icon-inner", innerHTML: this.svgContent })) : ((0,_index_e0fb4cab_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", { class: "icon-inner" }))));
    };
    ...
    Object.defineProperty(Icon.prototype, "el", {
        get: function () { return (0,_index_e0fb4cab_js__WEBPACK_IMPORTED_MODULE_1__.c)(this); },
        enumerable: false,
        configurable: true
    });

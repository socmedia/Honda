<x-guest-layout>
        ...
        <div class="container-fluid">
            ...
            <div class="swiper-container pb-4">
                ...
                <div class="swiper-wrapper">
                    <!-- Slides -->
                    <div class="swiper-slide not-full">
                        <div class="text-center">
                            <img src="{{asset('images/genio/83277.jpg')}}" alt="">
                        </div>
                    </div>
                    <div class="swiper-slide not-full">
                        <div class="text-center">
    ...
    <main>
        <div class="container">
            ...
            <ul class="nav justify-content-center nav_tabs mt-4 mb-3" id="pills-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="pills-engine-tab" data-toggle="pill" href="#pills-engine" role="tab"
                        aria-controls="pills-engine" aria-selected="true">
                        Mesin
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="pills-frame-tab" data-toggle="pill" href="#pills-frame" role="tab"
                        aria-controls="pills-frame" aria-selected="false">
                        Rangka & Kaki Kaki
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="pills-dimension-tab" data-toggle="pill" href="#pills-dimension" role="tab"
                        aria-controls="pills-dimension" aria-selected="false">
                        Dimensi & Berat
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="pills-capacity-tab" data-toggle="pill" href="#pills-capacity" role="tab"
                        aria-controls="pills-capacity" aria-selected="false">
                        Kapasitas
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="pills-electricity-tab" data-toggle="pill" href="#pills-electricity"
                        role="tab" aria-controls="pills-electricity" aria-selected="false">
                        Kelistrikan
                    </a>
                </li>
            </ul>
            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane bg-light shadow-sm px-5 py-3 show active" id="pills-engine" role="tabpanel"
                    aria-labelledby="pills-engine-tab">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquid corrupti adipisci voluptatem,
                    veritatis quod dolorem nam fuga et nesciunt unde.
                </div>
                <div class="tab-pane bg-light shadow-sm px-5 py-3" id="pills-frame" role="tabpanel"
                    aria-labelledby="pills-frame-tab">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Minus laborum consequuntur quas aut commodi
                    nemo asperiores voluptates recusandae quaerat cupiditate?
                </div>
                <div class="tab-pane bg-light shadow-sm px-5 py-3" id="pills-dimension" role="tabpanel"
                    aria-labelledby="pills-dimension-tab">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Cupiditate, qui sequi? Veniam sed id
                    impedit fugiat nihil minus temporibus sapiente?
                </div>
                <div class="tab-pane bg-light shadow-sm px-5 py-3" id="pills-capacity" role="tabpanel"
                    aria-labelledby="pills-capacity-tab">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Cupiditate, qui sequi? Veniam sed id
                    impedit fugiat nihil minus temporibus sapiente?
                </div>
                <div class="tab-pane bg-light shadow-sm px-5 py-3" id="pills-electricity" role="tabpanel"

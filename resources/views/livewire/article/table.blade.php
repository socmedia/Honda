            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-lg-4 mb-3">
                        <article class="article article-style-c {{$data->published === 1 ? '' : 'draft'}}">
                            <div class="article-header">
                                <div class="article-image"
                                    style="background-image: url({{route('get.article', explode('/', $data->image))}}); background-position: center top">
                                </div>
                            </div>
                            <div class="article-details">
                                ...
                                <div class="article-title">
                                    <h2><a href="{{route('adm.article.show', $data->slug_title)}}"> {{$data->title}}</a>
                                    </h2>
                                </div>
                                <p>
                                    {{$data->subject}}
                                ...
                                <div class="d-flex justify-content-end">
                                    <div class="btn-group shadow-sm rounded-lg" role="group">
                                        <a href="{{route('adm.article.edit', $data->slug_title)}}"
                                            class="btn btn-light btn-sm shadow-none" title="Ubah Artikel">
                                            <i class="fas fa-pencil-alt"></i>
                                        </a>
                                        <button class="btn btn-light btn-sm shadow-none" title="Hapus Artikel"
                                            data-url="{{route('adm.article.destroy', $data->id)}}"

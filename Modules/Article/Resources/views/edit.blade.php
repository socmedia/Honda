...
<div class="container-fluid">
    ...
    <div class="col-12">
        ...
        <form action="{{route('adm.article.update', $article->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('put')
            ...
            <div class="row">
                                ...
                                <div class="dropzone-desc">
                                    ...
                                    <div class="preview-zone">
                                        <div class="box box-solid">
                                            <div class="box-body">
                                                <img class="w-50"
                                                    src="{{route('get.article', explode('/', $article->image))}}"
                                                    alt="">
                                            </div>
                                        </div>
                                    </div>
                ...
                {{-- Informasi Artikel --}}
                <div class="col-12 col-lg-4">
                    <h5 class="card-title text-uppercase"><b>Perbarui Informasi Artikel</b></h5>
                    <p>
                        Perbarui Informasi Artikel untuk menujukkan bahwa Artikel ini berbeda dengan Artikel yang
                        banyak beredar.
                    </p>
                </div>
                ...
                <div class="col-12 col-lg-8">
                    ...
                    <div class="white-box shadow-sm rounded-lg repeater">
                        ...
                        <fieldset class="form-group">
                            ...
                            <input type="text" class="input_tag form-control" name="tags"
                                value="{{old('tags') ? old('tags') : $article->tags }}">
                            @error('tags')
                            <small class="text-danger">{{$message}}</small>
                            @enderror
                        </fieldset>
                        ...
                        <fieldset class="form-group">
                            ...
                            <textarea class="form-control" name="subject"
                                style="resize: none; height: 100px">{{old('subject') ? old('subject') : $article->subject }}</textarea>
                            @error('subject')
                            <small class="text-danger">{{$message}}</small>
                            @enderror
                        </fieldset>
                ...
                {{-- Badan Artikel --}}
                <div class="col-12 col-lg-4">
                    <h5 class="card-title text-uppercase"><b>Perbarui Badan Artikel</b></h5>
                    <p>
                    ...
                    <div class="white-box shadow-sm rounded-lg">
                        ...
                        <fieldset class="form-group">
                            ...
                            <textarea class="form-control" name="description" id="editor"
                                style="resize: none;">{{old('description') ? old('description') : $article->description }}</textarea>
                            @error('description')
                            <small class="text-danger">{{$message}}</small>
                            @enderror
                        </fieldset>

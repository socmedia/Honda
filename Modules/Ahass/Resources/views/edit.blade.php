    ...
    <div class="col-12">
        <div class="row">
            ...
            <div class="col-12 col-lg-8">
                ...
                <form action="{{route('adm.ahass.update', $shass->id)}}" method="POST">
                    @csrf
                    @method('put')
                        ...
                        <fieldset class="form-group row">
                            ...
                            <div class="col-12 col-md-6 mb-3 mb-md-0">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="phone_1" class="form-control" value="{{$ahass->phone_1}}"
                                        data-input="" readonly>
                                </div>
                                @error('phone_1')
                                <small class="text-danger">{{$message}}</small>
                            ...
                            <div class="col-12 col-md-6 mb-3 mb-md-0">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="phone_2" class="form-control" value="{{$ahass->phone_2}}"
                                        data-input="" readonly>
                                </div>
                                @error('phone_2')
                                <small class="text-danger">{{$message}}</small>

...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <form action="{{route('adm.accessories.update', $accessory->id)}}" method="POST"
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-4">
                        <h5 class="card-title text-uppercase"><b>Ubah Aksesoris</b></h5>
                        <p>
                            Anda bisa melakukan pembaruan data Aksesoris dengan mengganti nilai dari form disamping.
                        </p>
                    </div>
                    ...
                    <div class="col-12 col-lg-8">
                        ...
                        <div class="white-box shadow-sm rounded-lg">
                            ...
                            <fieldset class="form-group">
                                <label for="image">Pilih gambar aksesoris <sub class="text-muted">(Kosongkan jika tidak
                                        ada perubahan)</sub></label> <br>
                                    ...
                                    <div class="dropzone-desc">
                                        ...
                                        <div class="preview-zone">
                                            <div class="box box-solid">
                                                <div class="box-body">
                                                    <img src="{{route('get.accessory', $accessory->image)}}"
                                                        class="w-50">
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <fieldset class="form-group row">
                                <div class="col-12 col-md-6 mb-3 mb-lg-0">
                                    ...
                                    <input type="text" class="form-control" name="name"
                                        value="{{old('name') ? old('name') : $accessory->name}}">
                                    @error('name')
                                    <small class="text-danger">{{$message}}</small>
                                    @enderror
                                </div>
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="parts_number"
                                        value="{{old('parts_number') ? old('parts_number') : $accessory->parts_number}}">
                                    @error('parts_number')
                                    <small class="text-danger">{{$message}}</small>
                                    @enderror
                                </div>
                                ...
                                <div class="col-12 col-md-6 mb-3 mb-lg-0">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="price" maxlength="20" class="form-control numeric"
                                            placeholder="" value="{{old('price') ? old('price') : $accessory->price}}">
                                    </div>
                                    @error('price')
                                    <small class="text-danger">{{$message}}</small>
                                    @enderror
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <select name="product" class="form-control select_searchable">
                                        ...
                                        <option value="{{$product->id}}"
                                            {{$accessory->products_id === $product->id ? 'selected' : ''}}>
                                            {{$product->name}}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <fieldset class="form-group">
                                ...
                                <div class="color-picker">
                                    <div class="clone-box">
                                        ...
                                        <div class="color-picker-display" style="background-color: {{$color}}">
                                    ...
                                    <div class="btn-group" role="group">
                                        ...
                                        <button type="button" class="btn btn-sm btn-primary"
                                            data-action="remove-last-color" @if (old('colors'))
                                            {{count(old('colors')) > 1  || count(explode(',', $accessory->colors)) > 1 ? '' : 'disabled'}}>
                                            @else
                                            {{count(explode(',', $accessory->colors)) > 1 ? '' : 'disabled'}}>
                                            @endif
                            ...
                            <fieldset class="form-group">
                                ...
                                <textarea class="form-control" id="editor" style="resize: none; height: 120px"
                                    name="function">{{old('function') ? old('function') : $accessory->function}}</textarea>
                                @error('function')
                                <small class="text-danger">{{$message}}</small>
                                @enderror
                            </fieldset>
                            ...
                            <fieldset class="form-group">
                                <label for="material">Bahan aksesoris <sub class="text-muted">(Harus
                                        diisi)</sub></label>
                                <textarea class="form-control" id="editor" style="resize: none; height: 120px"
                                    name="material">{{old('material') ? old('material') : $accessory->material}}</textarea>
                                @error('material')
                                <small class="text-danger">{{$message}}</small>
                                @enderror
                            </fieldset>
                            ...
                            <fieldset class="form-group">
                                <div class="custom-control custom-checkbox">
                                    <input class="custom-control-input" type="checkbox" name="show_in_catalogue"
                                        id="show_in_catalogue" {{$accessory->show_in_catalogue == 1 ? 'checked' : ''}}>

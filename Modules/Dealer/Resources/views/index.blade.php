...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12 col-md-6">
            <h3 class="card-title mb-5">Daftar Dealer</h3>
        </div>
            ...
            <div class="btn-group" role="group" aria-label="Basic example">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <a class="dropdown-item" href="{{route('adm.dealer.export.excel')}}" target="_blank">
                            <i class="fa fa-file-excel mr-3"></i> Excell
                        </a>
                    </div>
                </div>
                <a href="{{route('adm.dealer.create')}}" class="btn btn-primary">+ Dealer</a>
            </div>
        </div>
    </div>
